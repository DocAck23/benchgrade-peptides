...
export default function CompliancePage() {
  return (
    <article className="max-w-3xl mx-auto px-6 lg:px-10 py-20 lg:py-28">
      ...
      <h1 className="font-display text-5xl lg:text-6xl leading-tight text-[color:var(--color-ink)] mb-10">
        A chemical supplier for laboratory research.
      </h1>

      <div className="prose-spacing space-y-8 text-[color:var(--color-ink-soft)] text-base lg:text-lg leading-relaxed">
        <p className="text-[color:var(--color-ink)] font-medium">
          {RUO_STATEMENTS.banner}
        </p>

        <section>
          <h2 className="font-display text-2xl text-[color:var(--color-ink)] mb-4">
            What Bench Grade Peptides is
          </h2>
          <p>
            Bench Grade Peptides LLC is a specialty research-chemical distributor. We supply lyophilized
            synthetic peptides to laboratories, research institutions, and qualified researchers for in
            vitro research purposes.
          </p>
        </section>

        <section>
          <h2 className="font-display text-2xl text-[color:var(--color-ink)] mb-4">
            What Bench Grade Peptides is not
          </h2>
        ...
        <section>
          ...
          <blockquote className="border-l-4 border-[color:var(--color-teal)] pl-6 py-2 my-6 italic text-[color:var(--color-ink-soft)]">
            {RUO_STATEMENTS.certification}
          </blockquote>
          <p>
            This certification is timestamped, logged against the purchase, and retained permanently as
            part of our compliance audit trail. See our{" "}
            <Link href="/terms" className="text-[color:var(--color-teal)] underline">
              Terms of Sale
            </Link>{" "}
        ...
        <section>
          ...
          <p>
            Every product we ship is traceable to a specific lot, a specific manufacturer Certificate of Analysis (COA),
            and a specific customer certification. COAs are published per-lot and linked from every product page.
            HPLC and mass spectrometry identity/purity data accompany every lot.
          </p>
        </section>
