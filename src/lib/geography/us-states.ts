...
/**
 * Code → display name. Same set as US_STATES_AND_TERRITORIES, kept
 * here so checkout / account forms can render a friendly dropdown
 * instead of forcing customers to know the 2-letter abbreviation.
 */
export const US_STATES_OPTIONS: ReadonlyArray<{ code: string; name: string }> = [
